...
export default function CaseStudyCard({
  ...
  return (
    <Link href={`/case-studies/${slug}`} className="block no-underline">
      <article
      ...
      >
        ...
        <div className="relative">
          <div className="flex flex-wrap items-center gap-2 mb-4">
            {featured && (
              <span className="inline-flex items-center gap-1.5 text-xs font-medium text-[var(--color-accent)] uppercase tracking-wider">
          ...
          <div className="inline-flex items-center gap-2 mt-6 text-[var(--color-accent)] font-medium group-hover:gap-3 transition-all">
