...
export default function HomePage() {
  ...
  return (
    <>
        ...
        <div className="section-container mt-8">
          <div className="about-details-container">
            <div className="about-containers">
              ...
              <div className="details-container">
                <div className="flex items-start gap-4">
                  <EducationIcon />
                  <div>
                    <h3 className="font-semibold">Typical reasons to hire me</h3>
                    <ul className="mt-3 list-disc list-inside text-[var(--color-text-secondary)] space-y-1">
            ...
            <div className="text-container">
              <p>
                Lead Frontend Developer / Frontend Architect with a focus on building and stabilizing
                complex frontend systems. From greenfield launches and architectural decisions to
                refactoring legacy codebases and creating internal tooling that speeds up delivery.
                I work with React, Next.js, TypeScript, and Node.js ecosystem. Available for Upwork,
                part-time, consulting, and short-term projects.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* How I Help Section */}
      <section id="how-i-help" className="relative mx-4 md:mx-16 lg:mx-40 py-16">
        ...
        <div className="experience-details-container mt-8">
          <div className="about-containers flex-wrap justify-center">
            {projects.slice(0, 3).map((project) => (
              <div key={project.title} className="details-container color-container max-w-sm">
                ...
                <p className="text-[var(--color-text-secondary)] text-sm mb-4 px-2">{project.description}</p>
                {project.role && (
                  <p className="text-[var(--color-text-muted)] text-xs mb-4">{project.role}</p>
                )}
                <div className="btn-container">
                  <Link href="/projects" className="btn btn-color-2 project-btn text-sm">
                    View Details
                  </Link>
                </div>
              </div>
      ...
      {/* Contact Section */}
      <section id="contact" className="flex justify-center flex-col h-[70vh] mx-4 md:mx-16 lg:mx-40 py-16">
        ...
        <div className="contact-info-upper-container">
          <div className="contact-info-container">
            <EmailIcon />
            <p>
              <a href="mailto:in.korobeynikov@gmail.com" className="hover:underline">
